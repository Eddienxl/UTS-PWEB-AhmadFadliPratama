    ...
    <div className="min-h-screen bg-gray-900 py-8 text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-6">
          <Link
            to="/surah"
            className="inline-flex items-center text-gray-400 hover:text-primary"
          >
        ...
        <div className="mb-8 relative max-w-2xl mx-auto">
          <div className={`flex items-center border ${isSearchFocused ? 'border-primary ring-2 ring-primary/30' : 'border-gray-700'} rounded-lg bg-gray-800 transition-all duration-200`}>
            <div className="pl-4">
